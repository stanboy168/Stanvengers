...
export function DefinedRiskModule() {
  return (
    <div className="flex flex-col h-full">
      <div className="flex-1 overflow-y-auto">
        <ConceptSlide>
          <Headline>Defined-Risk Strategies</Headline>
          <Body>Spreads, condors, butterflies — coming soon.</Body>
          <ConceptCard title="This module is under construction" accent="sky">
            <p>
